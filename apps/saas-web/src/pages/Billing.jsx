  ...
  return (
    <div className="animate-in fade-in space-y-6 duration-500">
      ...
      <div className="flex flex-col gap-4 border-b border-slate-200/80 pb-6 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-xl text-sm font-medium text-slate-600">
            Manage your API subscription plan, upgrade quotas, and review
      ...
      {message && (
        ...
        >
          <div
            className={`shrink-0 rounded-lg p-1.5 ${message.includes("Successfully") ? "bg-emerald-100" : "bg-rose-100"}`}
          >
      ...
      <div className="grid max-w-5xl grid-cols-1 items-stretch gap-8 text-left lg:grid-cols-2">
        {/* Free Plan */}
        <div className="relative flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-slate-300 sm:p-8">
          {user?.subscriptionTier === "free" && (
            <span className="absolute top-6 right-6 shrink-0 rounded-full border border-blue-200/80 bg-blue-50 px-3 py-1 text-xs font-bold text-blue-600">
              CURRENT PLAN
            </span>
          )}
          <div>
          ...
          <button
            disabled
            className="w-full cursor-not-allowed rounded-xl bg-slate-100 py-3 text-center text-sm font-bold text-slate-400 transition-colors"
          >
            {user?.subscriptionTier === "free"
              ? "Current Active Plan"
              : "Start for free"}
        ...
        <div className="relative flex flex-col justify-between rounded-2xl border-2 border-blue-600 bg-white p-6 shadow-xl shadow-blue-600/5 sm:p-8">
          ...
          {user?.subscriptionTier === "free" ? (
            <button
              ...
              disabled={upgrading}
              className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-blue-600 py-3 text-center text-sm font-bold text-white shadow-sm transition-all hover:bg-blue-700 active:scale-98"
            >
              {upgrading ? (
            ...
            <div className="flex w-full items-center justify-center gap-2 rounded-xl border border-emerald-200 bg-emerald-50 py-3 text-center text-sm font-bold text-emerald-700 uppercase">
